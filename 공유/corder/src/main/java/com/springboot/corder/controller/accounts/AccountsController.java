...
import com.springboot.corder.service.member.MemberSignUpService;
    ...
    public String signup(@Valid MemberSignUpDto memberRequestDto, BindingResult bindingResult, Model model){
        ...
        try {
            ...
            if (bindingResult.hasErrors()) {
                ...
                Map<String, String> validatorResult = memberSignUpService.validateHandling(bindingResult);
            ...
            memberSignUpService.create(memberRequestDto.getEmail(), memberRequestDto.getName(), memberRequestDto.getNick(), pwd1);
